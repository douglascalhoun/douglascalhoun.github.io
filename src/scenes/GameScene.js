...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        // World size - large enough to fly around
        ...
        // Create planet at center of system
        this.createPlanet(worldSize / 2, worldSize / 2, 300);
        
        // Create system boundary ring
    ...
    createPlanet(x, y, radius) {
        // Create planet with simple gradient effect
